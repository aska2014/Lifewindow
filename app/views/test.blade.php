<?php
    ...
    $rssUrl = "https://www.facebook.com/feeds/page.php?format=rss20&id=551870901518231";
...
<!-- 
                                ...
                                <div class="recent-post">
                                    <a href="{{ $post->getLink() }}"><img src="{{ URL::asset('img/logo.jpg') }}" alt="Post" width="50" /></a>
                                    <div class="post-head" style="width:160px;">
                                        <a href="{{ $post->getLink() }}">{{ Str::words($post->getTitle(), 5) }}</a><span> {{ $post->getDate() }}</span>
                                    </div>
                                </div>
                                @endforeach
                             -->